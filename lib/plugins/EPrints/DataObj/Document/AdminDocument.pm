######################################################################
#
# EPrints::DataObj::Document::AdminDocument
#
######################################################################
#
#
...
B<EPrints::DataObj::Document::AdminDocument> - A single admin record.

=head1 DESCRIPTION

AdminDocument represents a single format of an EPrint (eg. PDF) - the 
actual file(s) rather than the metadata.

This class is a subclass of Document, and is intended to enable the storage
of files within an eprint for administration purposes only.

AdminDocuments have the same metadata fields as Documents, but some properties
and methods are overridden or set to default values to ensure they are not made public.

=cut

package EPrints::DataObj::Document::AdminDocument;
...
####################################################################
# DOCUMENT BELOW THIS POINT (TO EDIT)
####################################################################
